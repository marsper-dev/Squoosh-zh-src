...
const demos = [
  {
    description: '大图 (2.8mb)',
    filename: 'photo.jpg',
    url: largePhoto,
    iconUrl: largePhotoIcon,
  },
  {
    description: '艺术 (2.9mb)',
    filename: 'art.jpg',
    url: artwork,
    iconUrl: artworkIcon,
  },
  {
    description: '设备 (1.6mb)',
    filename: 'pixel3.png',
    url: deviceScreen,
    iconUrl: deviceScreenIcon,
  },
  {
    description: 'SVG 图标 (13k)',
      ...
      <div class={style.intro}>
        <div>
          ...
          <p class={style.openImageGuide}>
            拖拽  或 {' '}
            <button class={style.selectButton} onClick={this.onButtonClick}>上传一张图片</button>
            <input
              class={style.hide}
